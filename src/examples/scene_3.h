const std::shared_ptr<collection> getScene3() {
    ...
    scene->add(std::make_shared<sphere>(point3(-0.5,    0.0, -1.0),   0.5, material_left, "left"));
    scene->add(std::make_shared<sphere>(point3( 0.5,    0.0, -1.0),   0.5, material_right, "right"));
